// More API functions here:
    ...
    const URL = "https://teachablemachine.withgoogle.com/models/uQsG5SJxe/";
    ...
    async function init() {
        ...
        button.style.display = "none"; // This will hide the button when clicked
        ...
        div.style.display = "block"; // This will make the div visible when the button is clicked
